  ...
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
      {metrics.map((metric, i) => (
        <div key={i} className="glass-card bg-card p-8 rounded-[2rem] flex flex-col justify-between group hover:bg-accent/5 transition-all duration-500 border border-border/40 shadow-xl relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-8 text-xl">
            <div className={`w-14 h-14 rounded-2xl ${metric.bg} flex items-center justify-center ${metric.color} shadow-inner group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
          ...
          <div>
            ...
            <h3 className="text-3xl font-headline font-black text-foreground tracking-tight">
