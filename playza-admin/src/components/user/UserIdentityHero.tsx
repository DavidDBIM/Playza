            ...
            <div className="space-y-6 max-w-xl">
              <div className="space-y-3">
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
                  <h2 className="text-4xl md:text-6xl font-headline font-black text-foreground tracking-tighter leading-none">
                    {user.username}
                  </h2>
                  <div className="flex items-center gap-3">
                    <span
                      className={`px-4 py-2 rounded-2xl text-[10px] font-black tracking-[0.2em] flex items-center gap-2 shadow-sm border ${
                        user.status === "Active"
                ...
                <p className="text-2xl md:text-3xl font-body font-bold text-muted-foreground/80 tracking-tight">
                  {user.fullName}
                </p>
              </div>
          ...
          <div className="flex flex-wrap items-center lg:flex-col lg:items-end gap-3 w-full lg:w-auto">
            ...
            {user.status !== "Active" ? (
              <Button
                ...
                className="flex-1 sm:flex-none bg-emerald-500 hover:bg-emerald-600 text-white font-black px-6 h-12 rounded-xl flex items-center justify-center gap-2 uppercase text-[10px] tracking-widest transition-all"
              >
                <MdVerified className="text-base" />
              ...
              <Button
                ...
                variant="outline"
                className="flex-1 sm:flex-none bg-slate-50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 text-slate-700 dark:text-slate-300 font-black px-6 h-12 rounded-xl flex items-center justify-center gap-2 border border-slate-200 dark:border-white/10 uppercase text-[10px] tracking-widest transition-all"
              >
            ...
            <Button
              ...
              variant="outline"
              className="flex-1 sm:flex-none border-rose-500 border bg-rose-500/5 hover:bg-rose-500 hover:text-white text-rose-500 font-black px-6 h-12 rounded-xl flex items-center justify-center gap-2 transition-all uppercase text-[10px] tracking-widest"
            >
              <MdBlock className="text-base" />
