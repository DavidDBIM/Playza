...
const LoyaltyLeaderboardTable: React.FC<LoyaltyLeaderboardTableProps> = ({ data }) => {
  const tierColors: { [key: string]: string } = {
    ...
    Silver: 'bg-muted/40 text-muted-foreground/70 border-border/40 shadow-muted/20',
        ...
        <Table>
          <TableHeader className="bg-muted/30/50 dark:bg-white/5 border-b border-white/10">
            <TableRow className="hover:bg-transparent border-none">
              ...
              <TableHead className="px-6 py-6 text-[10px] text-muted-foreground uppercase tracking-widest pl-12 h-auto shadow-none border-none font-black">Citizen Identity</TableHead>
              <TableHead className="px-6 py-6 text-[10px] text-muted-foreground uppercase tracking-widest text-center h-auto shadow-none border-none font-black">Engagement Tier</TableHead>
              <TableHead className="px-6 py-6 text-[10px] text-muted-foreground uppercase tracking-widest text-right pr-15 h-auto shadow-none border-none font-black">PZA Points</TableHead>
              <TableHead className="px-6 py-6 text-[10px] text-muted-foreground uppercase tracking-widest h-auto shadow-none border-none font-black">Activity Pulse</TableHead>
            </TableRow>
          </TableHeader>
              ...
              >
                ...
                <TableCell className="px-6 py-6 text-right pr-15">
                  <div className="flex flex-col items-end">
                    ...
                    <span className="text-[10px] uppercase text-muted-foreground tracking-widest font-black text-right block">Loyalty Capital</span>
                  </div>
                </TableCell>
                <TableCell className="px-6 py-6">
                   <div className="space-y-2 w-48">
                     <div className="flex items-center justify-between text-[10px] uppercase tracking-widest font-black">
                       ...
                       <span className="text-muted-foreground/70 tracking-tighter">Level {Math.floor(user.pzaPoints/1000)}</span>
                     </div>
                     <div className="h-2 w-full bg-muted/30 dark:bg-white/5 rounded-full overflow-hidden border border-white/5">
                        <div 
