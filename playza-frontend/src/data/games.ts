...
export const games: Game[] = [
  ...
  },
  {
    ...
    title: "8 Ball Pool",
    slug: "8-ball-pool",
    thumbnail: "/games/8-ball-pool.png",
    category: "Arcade",
    mode: "1v1",
    entryFee: 2000,
    difficulty: "Medium",
    ...
    platformFeePercentage: 10,
    howToPlay: {
      controls: "Drag to aim the cue stick, pull back to set power. Release to shoot. Use spin controls for advanced shots.",
      rules: "Official 8-ball rules: Pot your assigned balls (solids or stripes) first, then pot the 8-ball to win. Fouls include scratching and no ball hit.",
      scoring: "Win by legally potting the 8-ball after clearing all your balls.",
    },
