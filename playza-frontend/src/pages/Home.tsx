    ...
    <main className="flex-1 min-w-0 space-y-6">
      ...
      <Link to="/loyalty" className="block px-1">
        <div className="glass-card py-2 md:py-2.5 px-4 md:px-6 rounded-2xl flex items-center justify-between border border-primary/20 bg-primary/5 dark:bg-primary/10">
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-[10px] md:text-xs lg:text-sm font-black uppercase tracking-tight">Active Rewards</h3>
          ...
          <Button size="sm" className="h-7 md:h-8 text-[10px] px-3 md:px-5 font-black rounded-full bg-primary text-slate-900 shrink-0">
            VIEW REWARDS
          </Button>
        </div>
      </Link>
