        ...
        <div className="glass-card rounded-2xl md:rounded-3xl p-5 md:p-10 space-y-8 md:space-y-12 shadow-2xl border border-white/5 relative overflow-hidden">
            ...
            <section className="space-y-4 md:space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
                    <div className="p-4 md:p-6 bg-muted/40 rounded-2xl md:rounded-3xl border border-white/5 h-full">
            ...
            <section className="space-y-4 md:space-y-6 relative z-10">
                ...
                <ul className="list-disc pl-5 md:pl-6 space-y-2 md:space-y-4 text-xs md:text-sm text-muted-foreground">
                    ...
                    <p className="text-xs text-muted-foreground px-4 py-2 bg-muted/20 border-l-2 border-primary rounded-r-lg italic">
            ...
            <section className="space-y-4 md:space-y-6 relative z-10">
                ...
                <div className="bg-muted/30 p-5 md:p-8 rounded-2xl md:rounded-3xl grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 text-xs md:text-sm text-muted-foreground pl-4 border-l-2 border-primary">
                        <div className="space-y-2">
                            <p className="text-foreground font-black uppercase italic tracking-tighter">Service Delivery</p>
                            <p>To manage your account, process ZA transactions, and maintain live leaderboards.</p>
                        </div>
                        <div className="space-y-2">
                            <p className="text-foreground font-black uppercase italic tracking-tighter">Communication</p>
                            <p>To send security alerts, game updates, and prize winner notifications.</p>
                        </div>
                    </div>
                </section>
            ...
            <section className="space-y-4 md:space-y-6 relative z-10">
                ...
                <div className="bg-primary/5 rounded-2xl md:rounded-3xl p-4 md:p-6 border border-primary/20">
            ...
            <section className="space-y-4 md:space-y-6 relative z-10">
                ...
                <div className="bg-muted/50 p-4 md:p-6 rounded-2xl md:rounded-3xl flex flex-col md:flex-row gap-3 md:gap-4">
                    <div className="bg-background/80 p-3 md:p-4 rounded-xl md:rounded-2xl flex-1 border border-white/5">
                            ...
                            <p className="text-sm font-bold">privacy@playza.com</p>
                        </div>
                    <div className="bg-background/80 p-3 md:p-4 rounded-xl md:rounded-2xl flex-1 border border-white/5">
                            <p className="text-[10px] uppercase font-black text-primary mb-1">HQ Address</p>
                            <p className="text-sm font-bold italic">Lagos, Nigeria</p>
                        </div>
                    </div>
                </section>
