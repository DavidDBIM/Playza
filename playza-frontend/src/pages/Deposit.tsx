...
export default function Deposit() {
  ...
  return (
    <main className="flex-1 w-full max-w-2xl mx-auto py-4 flex flex-col  animate-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="glass-card rounded-xl px-2 py-8 md:p-12 relative overflow-hidden border border-primary/20 shadow-2xl">
        ...
        {status === "success" ? (
          ...
          <div className="space-y-8 relative z-10">
            ...
            <button
              ...
              className="w-full bg-primary hover:bg-primary/90 text-background dark:text-background-dark py-4 rounded-xl font-black uppercase tracking-widest transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-2 group disabled:opacity-70 disabled:pointer-events-none"
            >
              {status === "processing" ? (
                <>
