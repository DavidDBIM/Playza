...
const Wallet = ({ onWithdrawClick }: WalletProps) => {
  ...
  return (
    <main className="flex-1 min-w-0 flex flex-col gap-4 md:gap-10 pb-10 animate-in fade-in duration-500">
      {!isProfileComplete && (
        <div className="bg-amber-500/10 dark:bg-amber-500/5 border border-amber-500/30 dark:border-amber-500/20 rounded-2xl p-4 md:p-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4 text-center md:text-left">
            ...
            <div>
              <h4 className="text-amber-900 dark:text-amber-50 font-black uppercase tracking-tight">Withdrawals are Locked</h4>
              <p className="text-amber-800/70 dark:text-slate-400 text-sm">Complete your profile with your real name to enable withdrawals.</p>
            </div>
          </div>
          <Link 
            to="/profile/settings"
            className="flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-black px-6 py-3 rounded-xl font-bold transition-all text-sm group shrink-0"
          >
            Complete Profile
      ...
      <Link to="/loyalty" className="group">
        <div className="glass-card p-6 rounded-2xl border border-primary/20 flex flex-col sm:flex-row items-center justify-between gap-4 bg-linear-to-r from-primary/5 to-transparent hover:border-primary/40 transition-all shadow-xs">
          ...
          <div className="flex items-center gap-2 bg-primary/10 text-primary px-5 py-2.5 rounded-xl font-black text-xs uppercase tracking-widest group-hover:bg-primary/20 transition-colors">
            Go to Rewards
