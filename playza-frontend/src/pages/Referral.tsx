...
const Referral = () => {
  ...
  return (
    <div className="flex-1 max-w-7xl mx-auto w-full md:px-10 pb-20">
      {!user ? (
        <div className="mt-6 mb-12 glass-card p-10 rounded-[2.5rem] border-primary/20 relative overflow-hidden flex flex-col items-center text-center gap-8">
          ...
          <div className="relative z-10 space-y-4 max-w-2xl">
            <div className="size-20 bg-primary/20 rounded-xl flex items-center justify-center mx-auto mb-6 border border-primary/30 shadow-inner rotate-3 group-hover:rotate-6 transition-transform">
              <MdGroupAdd className="text-4xl text-primary" />
            </div>
        ...
        <div className="flex flex-col gap-2 mb-8 mt-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-400 text-sm md:text-base font-bold uppercase tracking-widest opacity-70">
