...
export const RulesTab = () => {
  ...
  return (
    <div className=" max-w-5xl mx-auto">
      {/* Timeline Steps */}
      <div className="relative space-y-4 md:space-y-12 before:absolute before:inset-0 before:ml-10 before:-translate-x-2 md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-slate-200 dark:before:bg-white/5">
        {steps.map((step, idx) => (
          <div key={idx} className="relative flex items-center gap-2 md:gap-6 md:justify-normal md:odd:flex-row-reverse group">
            {/* Icon Circle */}
            <div className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-white dark:bg-playza-dark border border-slate-200 dark:border-white/10 z-20 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
            ...
            {/* Content Card */}
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-4rem)] bg-white dark:bg-white/5 p-4 md:p-8 rounded-xl border border-slate-200 dark:border-white/5">
              <h3 className="text-lg md:text-xl font-black text-slate-900 dark:text-white mb-2 tracking-tight italic uppercase">
                {step.title}
              </h3>
      ...
      {/* Fair Play Notice */}
      <div className="mt-8 md:mt-16 bg-playza-green/10 border border-playza-green/30 rounded-xl p-6 md:p-8 flex items-center gap-2 md:gap-6">
        <div className="p-2 md:p-4 bg-playza-green/20 rounded-xl">
