    ...
    <div className="space-y-4 md:space-y-12">
      ...
      <div className="bg-white dark:bg-white/5 p-2 md:p-4 rounded-xl border border-slate-200 dark:border-white/5 space-y-6 shadow-xl">
        <div className="flex items-center gap-4 mb-2">
          ...
          <h2 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight italic uppercase">Game Overview</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
        ...
        <div className="bg-white dark:bg-white/5 p-4 md:p-8 rounded-xl border border-slate-200 dark:border-white/5 space-y-4 shadow-lg">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight italic uppercase">Scoring System</h3>
          </div>
          ...
          <div className="pt-4 space-y-3">
            <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-200 dark:border-white/5 shadow-inner">
        ...
        <div className="bg-white dark:bg-white/5 p-4 md:p-8 rounded-xl border border-slate-200 dark:border-white/5 space-y-4 shadow-lg">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight italic uppercase">Gameplay Highlights</h3>
          </div>
      ...
      {/* Final CTA Area */}
      <div className="p-4 md:p-8 bg-slate-900 dark:bg-linear-to-br dark:from-playza-blue/20 dark:via-playza-blue/5 dark:to-transparent rounded-3xl border border-slate-800 dark:border-playza-blue/20 text-center space-y-8 shadow-2xl">
        <div className="max-w-xl mx-auto space-y-4">
          <h2 className="text-xl font-black text-white tracking-tight uppercase italic">Ready to dominate?</h2>
        ...
        <div className="flex  items-center justify-center">
          <button className="w-full sm:w-auto px-10 py-5 bg-white dark:bg-primary text-slate-900 dark:text-white font-black rounded-2xl flex items-center justify-center gap-3 hover:bg-slate-100 dark:hover:bg-primary/90 transition-all shadow-xl shadow-playza-blue/20 group">
