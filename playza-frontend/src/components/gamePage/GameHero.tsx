...
export const GameHero = ({ game, pricePool }: GameHeroProps) => {
  return (
    <section className="relative w-full min-h-[380px] md:min-h-[480px] lg:min-h-[550px] flex items-center overflow-hidden rounded-2xl md:rounded-3xl mb-6 md:mb-8 group border border-slate-200 dark:border-white/5 shadow-xl transition-colors duration-300">
      ...
      <div className="relative z-10 w-full px-4 md:px-8 lg:px-12 py-6 md:py-10">
        <div className="flex flex-col lg:flex-row items-center lg:items-end gap-6 md:gap-10 lg:gap-16">
          ...
          <div className="relative group/portrait shrink-0">
            ...
            <div className="relative w-32 h-44 md:w-56 md:h-72 lg:w-64 lg:h-80 rounded-xl md:rounded-[2rem] overflow-hidden border-2 md:border-4 border-white/50 dark:border-white/10 shadow-2xl glass-panel p-2 md:p-3 transition-transform duration-500 hover:rotate-2 animate-fade-in-up bg-white/40 dark:bg-white/5 backdrop-blur-sm">
          ...
          <div className="flex-1 space-y-4 md:space-y-6 lg:pb-4 text-center lg:text-left">
            ...
            <div className="space-y-2 md:space-y-4">
              ...
              <p className="text-slate-600 dark:text-slate-300 text-xs md:text-base lg:text-lg font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0 transition-colors duration-300">
                Endless runner competitive challenge where every turn counts. Push your limits in <span className="text-slate-900 dark:text-white font-bold">{game.title}</span> and compete for the top of the leaderboard.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 md:gap-4 pt-2 md:pt-4">
              <div className="glass-card px-3 md:px-5 py-2 md:py-3 rounded-xl border border-slate-200 dark:border-white/5 flex items-center gap-3 hover:bg-slate-100 dark:hover:bg-white/5 transition-colors shadow-sm">
                ...
                <div className="flex flex-col items-start">
                  <span className="text-[7px] md:text-[9px] text-slate-500 font-black uppercase tracking-tight">Active</span>
                  <span className="text-xs md:text-base font-black text-slate-900 dark:text-white leading-none uppercase">{game.activePlayers.toLocaleString()}</span>
                </div>
              </div>
              ...
              <div className="glass-card px-3 md:px-5 py-2 md:py-3 rounded-xl border border-slate-200 dark:border-white/5 flex items-center gap-3 hover:bg-slate-100 dark:hover:bg-white/5 transition-colors shadow-sm">
                ...
                <div className="flex flex-col items-start">
                  <span className="text-[7px] md:text-[9px] text-slate-500 font-black uppercase tracking-tight">Sessions</span>
                  <span className="text-xs md:text-base font-black text-slate-900 dark:text-white leading-none uppercase">3</span>
                </div>
              </div>
              ...
              <div className="glass-card px-3 md:px-5 py-2 md:py-3 rounded-xl border-l-2 md:border-l-4 border-l-playza-green bg-playza-green/5 flex items-center gap-3 hover:bg-playza-green/10 transition-colors shadow-sm border-y border-r border-slate-200 dark:border-white/5">
                ...
                <div className="flex flex-col items-start">
                  <span className="text-[7px] md:text-[9px] text-playza-green/70 font-black uppercase tracking-tight">Pot</span>
                  <span className="text-xs md:text-base font-black text-playza-green font-mono tracking-tighter leading-none">{formatNaira(pricePool)}</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 md:pt-6">
              <Link to={`/games/${game.slug}/session`} className="inline-block w-full md:w-auto">                
