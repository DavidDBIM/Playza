        ...
        <div className="flex flex-col xl:flex-row items-center xl:items-end gap-6 md:gap-10 xl:gap-16">
          ...
          <div className="flex-1 space-y-4 xl:pb-4 text-center xl:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center xl:justify-start gap-2 md:gap-4">
              <div className="glass-card px-3 md:px-5 py-2 md:py-3 rounded-xl border border-slate-200 dark:border-white/5 flex items-center gap-2 md:gap-3 hover:bg-slate-100 dark:hover:bg-white/5 transition-colors shadow-xs">
