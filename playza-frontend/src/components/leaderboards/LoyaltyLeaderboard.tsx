              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="relative shrink-0">
                    <div className="w-9 h-9 rounded-xl overflow-hidden border-2 border-white/10 shadow-md">
                  ...
                  <div className="flex flex-col min-w-0">
                    <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 mb-0.5">#{player.rank}</p>
                ...
                <div className="flex flex-col items-end shrink-0">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs font-black text-primary">{player.pza_points.toLocaleString()}</span>
                  </div>
                  <span className="text-[8px] text-slate-400 font-bold uppercase tracking-widest leading-none">PZA</span>
                </div>
                {isFirst && (
              ...
              restOfPlayers.map((entry) => {
                ...
                >
                  <TableCell className="px-4 py-2.5 text-center">
                    <div className={`inline-flex items-center justify-center w-7 h-7 rounded-lg font-display font-black italic text-xs ${isMe ? 'bg-primary text-white' : 'bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-slate-400'}`}>
                      {entry.rank}
                    </div>
                  </TableCell>
                  <TableCell className="px-4 py-2.5">
                    <div className="flex items-center gap-2">
                      <div className="relative shrink-0">
                        <div className={`w-8 h-8 rounded-lg overflow-hidden border ${isMe ? 'border-primary' : 'border-slate-200 dark:border-white/10'} transition-transform shadow-sm`}>
