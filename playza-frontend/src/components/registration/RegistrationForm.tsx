...
import { User, Mail, Smartphone, Lock, Shield, ArrowRight, Eye, EyeOff, CheckCircle2, AlertCircle, ArrowLeft } from "lucide-react";
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="glass-card p-2 md:p-10 rounded-3xl shadow-2xl relative overflow-hidden border border-slate-200 dark:border-white/5 bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl">
          ...
          <div className="text-center mb-8 relative z-10">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm">Create your gaming profile and start competing.</p>
          </div>
          ...
          <form className="space-y-5 relative z-10" onSubmit={handleSubmit}>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full bg-slate-900/5 dark:bg-white/5 border rounded-xl py-3.5 pl-12 pr-4 focus:ring-2 outline-none text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-600 transition-all font-medium text-sm ${
                      confirmPassword && password !== confirmPassword ? "border-red-500/50 focus:ring-red-500/20" : "border-slate-200 dark:border-white/10 focus:ring-primary/30 focus:border-primary"
                    }`}
                    type="password"
                    placeholder="••••••••"
                  />
            ...
            <div className="flex items-start gap-3 px-1">
              ...
              />
              <label htmlFor="terms" className="text-[11px] leading-relaxed text-slate-500 dark:text-slate-400 font-medium cursor-pointer select-none">
                By creating an account, I agree to Playza's{" "}
                <Link to="/terms" target="_blank" className="text-primary font-bold hover:underline underline-offset-4">Terms & Conditions</Link>
                {" "}and{" "}
                <Link to="/privacy" target="_blank" className="text-primary font-bold hover:underline underline-offset-4">Privacy Policy</Link>.
              </label>
            </div>

            <div className="pt-4">
              <Button 
                disabled={isSubmitting || !password || password !== confirmPassword || strength < 25 || !acceptedTerms}
