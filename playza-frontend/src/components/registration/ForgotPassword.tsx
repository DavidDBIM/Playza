      ...
      <div className="glass-card w-full max-w-120 rounded-xl p-2 md:p-12 shadow-2xl relative overflow-hidden">
        ...
        {!isSuccess && (
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              disabled={isPending}
              className="w-full flex cursor-pointer items-center justify-center gap-2 rounded-lg h-14 px-5 bg-primary text-background-dark text-base font-bold tracking-wide shadow-[0_0_20px_rgba(19,218,236,0.3)] hover:shadow-[0_0_30px_rgba(19,218,236,0.5)] transition-all transform hover:-translate-y-0.5 disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none"
              type="submit"
            >
              {isPending ? (
                <>
        ...
        {isSuccess && (
          <div className="flex flex-col gap-4">
            <button
              onClick={() => onClick("login")}
              className="w-full flex cursor-pointer items-center justify-center gap-2 rounded-lg h-14 px-5 bg-primary text-background-dark text-base font-bold tracking-wide shadow-[0_0_20px_rgba(19,218,236,0.3)] hover:shadow-[0_0_30px_rgba(19,218,236,0.5)] transition-all"
            >
              Back to Login
            </button>
            <button
