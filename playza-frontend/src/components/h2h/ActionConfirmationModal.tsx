...
const ActionConfirmationModal = ({ confirmingAction, onCancel, onConfirm, isLoading }: ActionConfirmationModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-200 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-2 animate-in fade-in duration-300">
      <div className="w-full max-w-md bg-white dark:bg-slate-900 border-2 border-primary/30 rounded-3xl p-2 md:p-4 shadow-2xl space-y-6 md:space-y-8 animate-in zoom-in-95 duration-300">
        ...
        <div className="bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/10 rounded-2xl p-2 space-y-4 md:space-y-6">
          ...
          <div className="flex items-center justify-center gap-3 py-2">
            ...
            <span className="text-xl md:text-3xl font-black text-indigo-500 italic">
