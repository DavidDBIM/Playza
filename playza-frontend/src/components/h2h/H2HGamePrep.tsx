  ...
  chess: [
    {
      ...
      title: "Staked Match",
      description:
        "Your stake is locked in escrow. Winner takes the total prize pool minus 10% platform fee.",
      color: "text-primary",
    },
    {
      id: "02",
      ...
      description:
        "DO NOT navigate away. Leaving or closing the tab during an active match will forfeit your balance.",
    ...
    },
    {
      ...
      description:
        "Checkmate your opponent or win on time to claim the prize pool.",
  ...
  "speed-battle": [
    {
      ...
      title: "Speed is King",
      description:
        "You must type the entire paragraph exactly as shown. The faster you finish with high accuracy, the better.",
      color: "text-blue-500",
    },
    {
      id: "02",
      ...
      description:
        "Mistakes will slow you down. Correct errors immediately to maintain your flow.",
    ...
    },
    {
      ...
      title: "Stability",
      description:
        "Ensure a stable connection. Disconnecting during the sprint counts as an automatic forfeit.",
      color: "text-red-500",
    },
  ],
  "word-scramble": [
    {
      ...
      description:
        "Unscramble the letters to find the hidden word before the timer runs out for each round.",
    ...
    },
    {
      ...
      description:
        "Faster answers earn more points. The player with the highest total score after all rounds wins.",
      color: "text-pink-500",
    },
    {
      id: "03",
      ...
      title: "No Cheating",
      description:
        "Using external aids or refreshing the page will lead to an immediate disqualification.",
      color: "text-red-500",
    },
  ],
  pool: [
    {
      ...
      title: "Aim & Power",
      description:
        "Drag from the cue ball to aim. The farther you drag, the more power you apply to the shot.",
    ...
    },
    {
      ...
      description:
        "The first player to pocket a ball (other than the 8-ball) is assigned that group (Solids or Stripes).",
      color: "text-amber-500",
    },
    {
      id: "03",
      ...
      title: "The 8-Ball",
      description:
        "Pocketing the 8-ball before clearing your group results in an immediate loss. Pocket it last to win!",
      color: "text-red-500",
    },
  ],
};
      ...
      <div className="fixed inset-0 z-200 flex items-center justify-center p-2 bg-slate-950/80">
        <div className="w-full max-w-md bg-white dark:bg-slate-900 border-2 border-primary/30 rounded-xl p-4 md:p-8 space-y-8">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div>
              <h2 className="text-lg md:text-xl lg:text-2xl font-black uppercase italic tracking-tighter text-slate-900 dark:text-white leading-none">
                Stake Committed
              </h2>
          ...
          <div className="bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/10 rounded-2xl p-4 md:p-6 space-y-4">
            <p className="text-[10px] md:text-xs text-slate-500 font-bold uppercase tracking-widest text-center leading-relaxed italic">
              A stake of <span className="text-primary">{stake} ZA</span> has
              been successfully deducted from your wallet to secure this battle.
            </p>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5">
              ...
              <div className="text-right text-[10px]">
                ...
                <p className="font-black text-secondary italic">
                  +{stake * 2} ZA
                </p>
              </div>
            </div>
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="grid gap-4 md:gap-6">
            {currentRules.map((rule) => (
              ...
              >
                <div
                  className={`w-8 h-8 md:w-10 md:h-10 rounded-lg bg-black/5 dark:bg-white/5 flex items-center justify-center shrink-0 font-black ${rule.color} italic text-[10px]`}
                >
                  <rule.icon size={20} />
                </div>
                <div>
                  <h3 className="font-bold text-[10px] md:text-sm uppercase tracking-widest text-slate-900 dark:text-white mb-1">
                    {rule.title}
                  </h3>
                  <p className="text-[10px] md:text-xs text-slate-500 uppercase font-bold leading-relaxed italic">
                    {rule.description}
                  </p>
                </div>
              </div>
