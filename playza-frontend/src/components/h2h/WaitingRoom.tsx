    ...
    <div className="w-full min-h-[85vh] flex flex-col items-center justify-center animate-in fade-in zoom-in duration-700 relative px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-2">
            ...
            <h1 className="font-headline text-4xl md:text-5xl font-black text-foreground tracking-tight uppercase italic italic">
                Battle <span className="text-primary">Ready</span>
            </h1>
        </div>

        {/* Central Information Hub */}
        <div className="bg-card/40 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex flex-col items-center space-y-10">
                ...
                <div className="w-full text-center space-y-4">
                    ...
                    <div className="relative inline-block group/code transition-transform hover:scale-105">
                        <div className="absolute -inset-4 bg-primary/20 rounded-[2rem] blur-2xl opacity-0 group-hover/code:opacity-100 transition-opacity"></div>
                        <div className="relative bg-black/40 border-2 border-primary/30 rounded-2xl px-10 py-6 backdrop-blur-3xl">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                    {/* Host Card */}
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-5 flex items-center gap-4 group/host hover:border-primary/40 transition-all">
                        <div className="relative">
                            ...
                            <img 
                                alt="Host" 
                                className="w-14 h-14 rounded-xl relative border border-white/10 shadow-xl" 
                        ...
                        <div className="text-left">
                            ...
                            <h4 className="font-headline font-black text-xl text-foreground uppercase tracking-tight italic truncate max-w-[150px]">
                    ...
                    <div className="bg-black/20 border border-white/5 border-dashed rounded-2xl p-5 flex items-center gap-4 opacity-70 animate-pulse">
                        <div className="w-14 h-14 rounded-xl bg-white/5 flex items-center justify-center border border-white/5 border-dashed italic font-headline font-black text-2xl text-muted-foreground/30">
                            ?
                        </div>
                        <div className="text-left space-y-1">
                            <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground italic">Waiting...</p>
                            <h4 className="font-headline font-black text-xl text-muted-foreground/40 uppercase tracking-tight italic">
                                Seeking Rival
                            </h4>
        ...
        <div className="flex flex-col items-center pt-4">
             <button 
                ...
                className="text-muted-foreground hover:text-red-500 transition-all font-black text-[10px] uppercase tracking-[0.5em] italic flex items-center gap-4 group"
            >
                <div className="w-8 h-px bg-white/10 group-hover:bg-red-500/50 transition-colors"></div>
                Abort Match
                <div className="w-8 h-px bg-white/10 group-hover:bg-red-500/50 transition-colors"></div>
            </button>
            <p className="mt-8 text-muted-foreground/40 text-[9px] font-medium tracking-widest uppercase italic text-center">
