        ...
        <DropdownMenuContent align="start" className="w-40 glass-card p-1 border-white/10">
          {currencies.map((c) => (
            <DropdownMenuItem
              ...
              className="flex items-center justify-between text-xs font-bold py-2.5 px-3 cursor-pointer rounded-md focus:bg-primary/10 hover:bg-primary/5 transition-colors"
            >
