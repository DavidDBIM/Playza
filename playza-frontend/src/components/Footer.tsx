...
const Footer = ({ showAbout = true }: { showAbout?: boolean }) => {
  ...
  return (
    <footer className="relative bg-background dark:bg-playza-dark/50 border-t border-slate-200 dark:border-white/5 pt-6 md:pt-10 pb-28 md:pb-6 overflow-hidden">
      {/* Dynamic Glows */}
