...
const TransactionDetailModal = ({ isOpen, onClose, transaction }: TransactionDetailModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-100 p-2 flex items-center justify-center bg-slate-950/95 backdrop-blur-2xl transition-opacity overflow-y-auto" onClick={onClose}>
      <div 
