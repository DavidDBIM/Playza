...
This page links to the legal documents that govern your use of Playza. They are written to be readable — please take the time to skim them.
...
- Playza is **skill-based** entertainment. There is **no guaranteed return** from any contest — your outcome depends on your performance.
...
We may update these documents from time to time. When we make material changes, we'll notify players via the app and/or by email. Continued use of Playza after a change means you accept the updated terms.
